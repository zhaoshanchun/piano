...
- (void)viewDidLoad
{
    ...
    if (self.immediateReturn) {
        ...
        UIBarButtonItem *doneButtonItem = [[UIBarButtonItem alloc] initWithTitle:@"完成" style:UIBarButtonItemStyleDone target:self action:@selector(doneAction:)];
        [self.navigationItem setRightBarButtonItem:doneButtonItem];
        // Loading...
        [self.navigationItem setTitle:NSLocalizedString(@"正在加载", nil)];
    }
...
- (void)preparePhotos
{
    @autoreleasepool {
        ...
        dispatch_sync(dispatch_get_main_queue(), ^{
            ...
            // Pick Photo     Pick Photos
            [self.navigationItem setTitle:self.singleSelection ? NSLocalizedString(@"挑选照片", nil) : NSLocalizedString(@"挑选照片", nil)];
        });
    }
}
